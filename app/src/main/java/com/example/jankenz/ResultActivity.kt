...
class ResultActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        when( gameResult ){
            0 -> resultLabel.setText("引き分け") //引き分けの出力
            //0 -> resultLabel.setText(R.string.result_draw) //引き分けの出力
            1 -> resultLabel.setText("勝ち") //勝ち
            //1 -> resultLabel.setText(R.string.result_win) //勝ち
            2 -> resultLabel.setText("負け") //負けた
            //2 -> resultLabel.setText(R.string.result_lose) //負けた
        }
